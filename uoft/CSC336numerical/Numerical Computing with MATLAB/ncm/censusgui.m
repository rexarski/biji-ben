...
x = (1890:1:2029)';    % Evaluation years
w = 2020;              % Extrapolation target
guess = 350;           % Eyeball extrapolation
...
if nargin == 0
   ...
   shg
   clf reset
   set(gcf,'name','Censusgui','menu','none','numbertitle','off')
   ...
   axis([min(x) max(x) 0 425])
   title('Predict U.S. Population in 2020')
   ylabel('Millions')
