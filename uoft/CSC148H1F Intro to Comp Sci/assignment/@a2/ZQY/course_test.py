...
"""
import unittest
from course import (Course, AlreadyTakenError, UntakeableError, PrerequisiteError)
...
class TestCourse(unittest.TestCase):
    ...
    def test_add_existing_prereq(self):
        self.assertRaises(self.awe400.add_prereq(self.awe300), PrerequisiteError)
    ...
    def test_missing_nothing_first_year_course(self):
        # test a course without prereqs is missing nothing
        self.assertEqual(self.awe100.missing_prereqs(), [])
    
    def test_missing_nothing_higher_year_course(self):
        # test a course whose all prereqs are taken is missing nothing
        self.awe100.take()
        self.awe101.take()
        self.awe199.take()
