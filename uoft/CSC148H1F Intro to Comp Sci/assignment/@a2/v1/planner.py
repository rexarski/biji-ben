...
class TermPlanner:
    ...
    def is_valid(self, schedule):
        ...
        for term in schedule:
            ...
            # After all courses are verified to be takeable, take them!
            # The reason this is done separately from the above loop
            # is to ensure that co-requisites are not permitted.
            for takeable_course in temp_list:
                try:
