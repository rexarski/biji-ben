...
class TestCourse(unittest.TestCase):
    ...
    def test_takeable(self):
        ...
        # test whether a course whose all prereqs are taken is
        # takeable (it is as well!)
        self.awe100.take()
        self.awe101.take()
        self.awe199.take()
    ...
    def test_untakeable(self):
        # test whether a course which lacks of certain
        # prereq(s) is takeable (it is not!)
    ...
    def test_add_prereq_itself(self):
        self.assertRaises(PrerequisiteError, self.awe100.add_prereq,
                          self.awe100)

    def test_add_existing_children_prereq(self):
        self.assertRaises(PrerequisiteError, self.awe400.add_prereq,
                          self.awe300)
    ...
    def test_add_reversed_prereq(self):
        self.assertRaises(PrerequisiteError, self.awe300.add_prereq,
                          self.awe400)
    ...
    def test_missing_many(self):
        self.assertEqual(self.awe400.missing_prereqs(),
                         ['AWE100', 'AWE101', 'AWE199', 'AWE200',
                          'AWE250', 'AWE300'])
        self.awe100.take()
        self.awe101.take()
        self.awe199.take()
        self.assertEqual(self.awe400.missing_prereqs(),
                         ['AWE200', 'AWE250', 'AWE300'])

    def test_sort_many(self):
        self.assertEqual(self.awe300.missing_prereqs(),
                         ['AWE100', 'AWE101', 'AWE199', 'AWE200', 'AWE250'])
        self.awe100.take()
        self.awe101.take()
        self.awe199.take()
        self.assertEqual(self.awe300.missing_prereqs(),
