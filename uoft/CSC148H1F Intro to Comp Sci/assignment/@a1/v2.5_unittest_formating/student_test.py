...
# Should we create a SetUp class for all TestCases? If so, how?
# def setUp(self):
...
class TestCommonCourses(unittest.TestCase):    
    ...
    def test_common_courses_simple(self):
        ...
        # so far so good, problem is, how to assert the common course list of them is equal to ['MAT157']
...
class TestClassList(unittest.TestCase):
    ...
    #def test_list_students_taking_this_course(self):
        ...
        #self.assertEqual(self.school1.class_list('CSC148'), ['Ed', 'Jason',
                                                             #'Sally'])
    ...
    #def test_list_students_taking_an_empty_course(self):
        #self.school1.course_drop('Jason', 'CSC148')
        #self.assertEqual(self.school1.class_list('CSC148'), [])
...
class TestUndo(unittest.TestCase):
    ...
    #def test_undo_undo(self):
        ...
        #self.school2.course_drop('Ted', 'CSC148')
        #self.undo_once()
        #self.undo_once()  # when run undo twice in a row, the previous
        ## two commands are reversed
        #self.assertEqual([], self.school2.list_courses('Ted'))
