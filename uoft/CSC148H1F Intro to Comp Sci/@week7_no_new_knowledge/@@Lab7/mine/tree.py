...
class Tree:
    ...
    def get_branching_factor(self):
        ...
        if self.is_empty():
            ...
            branching_factor_helper = self.get_branching_factor_helper()
            return branching_factor_helper[0]/branching_factor_helper[1]
    ...
    def get_branching_factor_helper(self):
        ...
        for subtree in self.subtrees:
            subtree_branching_factor = subtree.get_branching_factor_helper()
            x += subtree_branching_factor[0]
            y += subtree_branching_factor[1]
            #if subtree.subtrees == []:
        # IF IT iS A LEAF:
        return (x,y)    
    ...
    def insert(self, item):
        ...
        if self.is_empty():
            ...
            if choice == 3:
                ...
                rand_index = random.randint(0,len(self.subtrees)-1)
                self.subtrees[rand_index].insert(item)
